...
//
//  val P = Parser(StateAction.unit[ParserState, Either[ParserError, Unit]](Right()))
//  import P._
//
//  object ParserLaws {
//
...
//
//  println("* Test string")
//  assert(string("ciao ciao").run("ciao ciao bella") == Right("ciao ciao"))
//  assert(string("ciao ciao").run("cia").left.get.stack.head._1.offset == 3)
//  assert(string("ciao ciao").run("ciao cIao").left.get.stack.head._1.offset == 6)
//
//  println("* Test regex")
//  assert(regex("""[a-d][i,o]g""".r).run("dog") == Right("dog"))
//  assert(regex("""[a-d][i,o]g""".r).run("doc").left.get.stack.head._1.offset == 0)
//
